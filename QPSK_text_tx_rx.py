...
# GNU Radio version: v3.11.0.0git-824-gebd01b9e
...
import QPSK_text_tx_rx_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading
...
class QPSK_text_tx_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500):
        ...
        self.delay = delay = 42
        self.cc_enc = cc_enc = fec.cc_encoder_make((MTU*8),k, 2, polys, 0, fec.CC_TRUNCATED, True)
        self.cc_dec = cc_dec = list(map( (lambda a: fec.cc_decoder.make((MTU*8),k, 2, polys, 0, (-1), fec.CC_TRUNCATED, True)),range(0,1)))
        self.bw = bw = 10e3
        self.arity = arity = 4
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/thevinduk/Documents/filename.txt', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/thevinduk/Documents/output.txt', False)
